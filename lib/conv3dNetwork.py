...
class Convolutionnal_Network(nn.Module):
    ...
    def __init__(self, nb_features_in, nb_features_out, shape, multiplicator, hidden_dim_linear):
        ...
        self.bn01 = nn.BatchNorm3d(self.input_dim*multiplicator)
        self.bn02 = nn.BatchNorm3d(self.input_dim*multiplicator)
        ...
        self.bn11 = nn.BatchNorm3d(self.input_dim*multiplicator*2)
        self.bn12 = nn.BatchNorm3d(self.input_dim*multiplicator*2)
        ...
        self.bn21 = nn.BatchNorm3d(self.input_dim*multiplicator*4)
        self.bn22 = nn.BatchNorm3d(self.input_dim*multiplicator*4)
        ...
        self.bn31 = nn.BatchNorm3d(self.input_dim*multiplicator*8)
        self.bn32 = nn.BatchNorm3d(self.input_dim*multiplicator*8)
        ...
        self.bn41 = nn.BatchNorm3d(self.input_dim*multiplicator*16)
        self.bn42 = nn.BatchNorm3d(self.input_dim*multiplicator*16)
